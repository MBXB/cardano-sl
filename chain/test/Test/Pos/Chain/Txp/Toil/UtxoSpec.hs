...
import           Test.QuickCheck (Property, generate, arbitrary, counterexample, (==>), forAll)
...
import           Pos.Crypto (RequiresNetworkMagic (..), ProtocolMagic, SignTag (SignTx), checkSig, fakeSigner, hash,
